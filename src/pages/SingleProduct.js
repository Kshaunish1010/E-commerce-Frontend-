...
const SingleProduct = () => {
    ...
    const props = {
     ...
     const [orderedProduct, setorderedProduct] = useState(true);//check if user has ordered product then he can write a review
                                ...
                                <div className=" py-3">
                                    ...
                                    <div className="d-flex gap-10 align-items-center my-3">
                                        ...
                                        <a
                                            ...
                                            //     );
                                            // }}
                                            onClick={() => {navigator.clipboard.writeText("https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?cs=srgb&dl=pexels-fernando-arcos-190819.jpg&fm=jpg")}}
                                        >
                                            Copy Product Link
                                        </a>
                                    </div>
